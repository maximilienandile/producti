...
Producti is a serverless API written in Go for e-commerce websites running with DynamoDb and Algolia.
...
* Thanks to DynamoDb streams, for each new record another Lambda is launched (`indexer`), this lambda will add an object
 to an Algolia Index
    * to get more info about DynamoDb Streams : [see here](https://www.serverless.com/blog/event-driven-architecture-dynamodb) 
* When a search by product name occurs, a query is made to the Algolia Index
